    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p><strong>Usuário de Abertura:</strong> <span id="usuarioAbertura">{{$usuario->name}}</span></p>
                <p><strong>Usuário de Fechamento:</strong> <span id="usuarioFechamento">{{$usuario->name}}</span></p>
