    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="showCaixaLabel">Detalhes das Contas A Pagar</h5>
            ...
            <div class="modal-body">
                ...
                <p><strong>Valor Inicial:</strong> <span id="valorInicial">{{$caixa->valor_inicial}}</span></p>
                <p><strong>Valor Final:</strong> <span id="valorFinal">{{$caixa->valor_final}}</span></p>
                ...
                <p><strong>Empresa:</strong> <span id="empresa">{{$caixa->empresa_id}}</span></p>
