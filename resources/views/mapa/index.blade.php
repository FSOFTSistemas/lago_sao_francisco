            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <span class="badge badge-primary mr-2">reservado</span>
                        <span class="badge badge-danger mr-2">hospedado</span>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="n_adultos" class="form-control" value="1"
                                        min="1" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="n_criancas" class="form-control" value="0"
                                        min="0">
                                </div>
                            </div>
                        </div>
