        ...
        <div class="card-body">
            <form id="createUsuarioForm" action="{{ isset($user) ? route('usuarios.update', $user->id) : route('usuarios.store') }}" method="POST">
                ...
                <div class="form-group row mb-4">
                    <label for="permissions" class="col-md-3 col-form-label text-md-right font-weight-bold">Permissões:</label>
                    <div class="col-md-8">
                        <div class="permissions-select-container">
                            <!-- Select2 -->
                            <select class="form-control select2-permissions" id="permissions" name="permissions[]" multiple="multiple" style="width: 100%;">
                                @php
...
<style>
    ...
    .select2-selection--multiple {
        ...
        color: #495057 !important;          /* Texto preto padrão */
