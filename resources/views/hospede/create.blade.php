...
@section('content')
    <div class="card">
        <div class="card-header green bg-primary text-white">
            <h3 class="card-title">
                {{ isset($hospede) ? 'Preencha os dados atualizados do Hóspede' : 'Preencha os dados do novo Hóspede' }}
            </h3>
        </div>
        <div class="card-body">
            <form id="createHospedeForm"
                action="{{ isset($hospede) ? route('hospede.update', $hospede->id) : route('hospede.store') }}" method="POST"
                ...
                <!-- Modal de Crop -->
                <div class="modal fade" id="cropImageModal" tabindex="-1" aria-hidden="true" data-backdrop="static"
                    data-keyboard="false">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <div><input class="form-control" required="required" type="text" name="nome" id="nome"
                                value="{{ old('nome', $hospede->nome ?? '') }}" autocomplete="off"></div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <div><input class="form-control" type="email" name="email" id="email"
                                value="{{ old('email', $hospede->email ?? '') }}"></div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <div><input class="form-control" type="text" name="passaporte" id="passaporte"
                                value="{{ old('passaporte', $hospede->passaporte ?? '') }}"></div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <div><input class="form-control" type="text" name="cpf" id="cpf"
                                value="{{ old('cpf', $hospede->cpf ?? '') }}"></div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <div><input class="form-control" type="date" name="nascimento" id="nascimento"
                                value="{{ old('nascimento', $hospede->nascimento ?? '') }}"></div>
                    </div>
                </div>
                        ...
                        <div>
                            <select class="form-control select2" id="sexo" name="sexo">
                                <option value="masculino"
                                    {{ old('sexo', $hospede->sexo ?? '') == 'masculino' ? 'selected' : '' }}>Masculino
                                </option>
                                <option value="feminino"
                                    {{ old('sexo', $hospede->sexo ?? '') == 'feminino' ? 'selected' : '' }}>Feminino
                                </option>
                                <option value="outro"
                                    {{ old('sexo', $hospede->sexo ?? '') == 'outro' ? 'selected' : '' }}>Outro</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <div><input class="form-control" type="text" name="profissao" id="profissao"
                                value="{{ old('profissao', $hospede->profissao ?? '') }}"></div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-check form-switch">
                        ...
                        <input class="form-check-input" type="checkbox" id="ativoSwitch" name="status" value="1"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <div><input class="form-control" type="tel" name="telefone" id="telefone"
                                value="{{ old('telefone', $hospede->telefone ?? '') }}"></div>
                    </div>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <button type="submit"
                        class="btn btn-primary">{{ isset($hospede) ? 'Atualizar Hóspede' : 'Adicionar Hóspede' }}</button>
                </div>
            </form>
        </div>
    </div>
