...
<h5>Configurações de Hotel / Cadastro</h5>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <a href="{{ route('cardapios-excursao.index') }}" class="card card-opcao text-center">
                <div class="card-body">
                    <i class="fas fa-clipboard-list fa-3x" style="color: #679A4C;"></i>
                    <h5 class="mt-3">Cardápios de Excursão</h5>
                </div>
            </a>
        </div>
        <div class="col-md-3">
