    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {!! $cliente->data_nascimento ? "<p><strong>Data de Nascimento:</strong> <span id='dataNascimento'></span>{$cliente->data_nascimento}</p>" : '' !!}

                <p><strong>Endereço:</strong> <span id="endereco"></span>{{$endereco->logradouro}}</p>
